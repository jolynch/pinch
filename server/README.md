...
echo "Read at localhost:8080/io/${FD}";

# Round trip compress and decompress
curl -svT yelp_academic_dataset_review.json "localhost:8080/io/${FD}?c&rw" | curl -svT - "localhost:8080/io/${RFD}?c&rw" | wc -c
...
$ curl -sT yelp_academic_dataset_business.json 'localhost:8080/io/14ccbb285f4d5822?c&rw' > business.zst.age
...
$ curl -sT business.zst.age 'localhost:8080/io/1805b02fce8ecca1?c&rw' | head
